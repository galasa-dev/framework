...
public class RASPathTest {
	...
	public void testStartsWith() {
		ResultArchiveStorePath path = new ResultArchiveStorePath(FileSystems.getDefault(), "/this/is/a/path");
		ResultArchiveStorePath path1 = new ResultArchiveStorePath(FileSystems.getDefault(), "/this/is");
		ResultArchiveStorePath path2 = new ResultArchiveStorePath(FileSystems.getDefault(), "this/is");
		ResultArchiveStorePath path3 = new ResultArchiveStorePath(FileSystems.getDefault(), "/hello/there");
		ResultArchiveStorePath path4 = new ResultArchiveStorePath(FileSystems.getDefault(), "/this/is/a/path/extra");
	...
	public void testEndsWith() {
		ResultArchiveStorePath path = new ResultArchiveStorePath(FileSystems.getDefault(), "/this/is/a/path");
		ResultArchiveStorePath path1 = new ResultArchiveStorePath(FileSystems.getDefault(), "a/path");
		ResultArchiveStorePath path2 = new ResultArchiveStorePath(FileSystems.getDefault(), "this/is/a/path");
		ResultArchiveStorePath path3 = new ResultArchiveStorePath(FileSystems.getDefault(), "b/path");
		ResultArchiveStorePath path4 = new ResultArchiveStorePath(FileSystems.getDefault(), "/this/is/a/path/extra");
	...
	public void testSimpleStuff() throws IOException {
		...
		ResultArchiveStorePath path = new ResultArchiveStorePath(fs, "/this/is/a/path");
		...
		try {
			...
			Assert.assertEquals("Unable to translate to a java.ioFile", e.getMessage());
		}
		...
		try {
			...
			Assert.assertEquals("Watching is not supported with this filesystem", e.getMessage());
		}
	...
	public void testRelativize() {
		...
		ResultArchiveStorePath path = new ResultArchiveStorePath(fs, "/this/is/a/path");
		ResultArchiveStorePath path1 = new ResultArchiveStorePath(fs, "/this/is/a/path/with/extra");
		
		ResultArchiveStorePath path2 = new ResultArchiveStorePath(fs, "this/is/a/path");
		ResultArchiveStorePath path3 = new ResultArchiveStorePath(fs, "this/is/a/path/with/extra");
		ResultArchiveStorePath path4 = new ResultArchiveStorePath(fs, "is/a/path/with/extra");
	...
	public void testResolve() {
		...
		ResultArchiveStorePath path = new ResultArchiveStorePath(fs, "/this/is/a/path");
		ResultArchiveStorePath path1 = new ResultArchiveStorePath(fs, "with/extra");
		ResultArchiveStorePath path2 = new ResultArchiveStorePath(fs, "/already/absolute");
		ResultArchiveStorePath path3 = new ResultArchiveStorePath(fs, "");
		
		Assert.assertEquals("Combined name is wrong", "/this/is/a/path/with/extra", path.resolve(path1.toString()).toString());
		Assert.assertTrue("absolute should have returned itself", path2 == path.resolve(path2));
		
		Assert.assertEquals("Combined name is wrong", "/this/is/a/with/extra", path.resolveSibling(path1.toString()).toString());
	...
	public void testCompareTo() {
		...
		ResultArchiveStorePath patha = new ResultArchiveStorePath(fs, "/this/is/a/path");
		ResultArchiveStorePath pathb = new ResultArchiveStorePath(fs, "/this/is/b/path");
		ResultArchiveStorePath pathc = new ResultArchiveStorePath(fs, "/this/is/c/path");
		ResultArchiveStorePath pathbshort = new ResultArchiveStorePath(fs, "/this/is/b");
		ResultArchiveStorePath pathroot = new ResultArchiveStorePath(fs, "/");
