...
public class TestRunLogRoute extends RasServletTest {
	...
	public void testRunResultWithLogBadAcceptHeaderReturnsError() throws Exception {
		...
		checkErrorStructure(outStream.toString(), 5412, "GAL5412",
			"E: Error occured when trying to access the endpoint '/runs/"+runId+"/runlog'. The request contains the header 'Accept' which does not match the expected value(s): 'text/plain , text/* , */*'.");
	}
