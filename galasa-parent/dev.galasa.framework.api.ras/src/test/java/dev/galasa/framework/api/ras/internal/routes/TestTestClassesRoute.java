...
public class TestTestClassesRoute extends RasServletTest{
	...
	public void testTestClassesWithTenTestBadAcceptHeaderReturnsOK() throws Exception {
		...
		checkErrorStructure( outStream.toString(), 5412 , 
			"E: Error occured when trying to access the endpoint '/testclasses'. The request contains the header 'Accept' which does not match the expected value(s): 'application/json , application/* , */*'." );
	}
}