 ...
 * 
 * For the JWT to be created, the user needs to be authenticated by the Servlet
 * Filters
 * 
 */
...
public class Authenticate extends HttpServlet {
    ...
    public String createJWT(String subject, String role, long expireDuration) throws JWTCreationException {
        ...
        String token = JWT.create().withIssuer("galasa").withIssuedAt(dateNow).withSubject(subject)
                .withClaim("role", role).withExpiresAt(dateExpire).sign(algorithm);
