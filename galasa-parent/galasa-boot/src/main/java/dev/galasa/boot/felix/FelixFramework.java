...
public class FelixFramework {
	...
	/**
	 * Initialise and start the Felix framework. Install required bundles and the OBRs. Install the Galasa framework bundle
	 * 
	...
	public void buildFramework(List<String> bundleRepositories, Properties boostrapProperties, URL localMavenRepo, List<URL> remoteMavenRepos) throws LauncherException, ClassNotFoundException {
		...
		try {
			...
			frameworkProperties.put(Constants.FRAMEWORK_SYSTEMPACKAGES_EXTRA, "org.apache.felix.bundlerepository; version=2.1, dev.galasa.framework, sun.misc, com.sun.net.httpserver, com.sun.management, org.xml.sax" 
					);
	...
	public void runTest(Properties boostrapProperties, Properties overridesProperties) throws LauncherException {
		...
		// Get the  dev.galasa.framework.TestRunner#runTest(String testBundleName, String testClassName) method
		Method runTestMethod;
		try {
