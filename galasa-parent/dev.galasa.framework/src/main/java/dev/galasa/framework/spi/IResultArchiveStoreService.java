...
/**
 * <p>Used by the Galasa Framework to initialise the various Result Archive Stores that may exist within the OSGi instance.  The 
 * framework can run with zero or more Result Archive Stores·</p>
 * 
 * <p>The RASs should use @{link dev.galasa.framework.spi.IFrameworkInitialisation#getResultArchiveStoreUris} to obtain a list of active
