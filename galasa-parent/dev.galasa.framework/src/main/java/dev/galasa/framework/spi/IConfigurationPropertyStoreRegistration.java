...
public interface IConfigurationPropertyStoreRegistration {
	 ...
	 * it should register the CPS with @{link {@link dev.galasa.framework.spi.IFrameworkInitialisation#registerConfigurationPropertyStore(IConfigurationPropertyStore)}</p> 
	 * 
