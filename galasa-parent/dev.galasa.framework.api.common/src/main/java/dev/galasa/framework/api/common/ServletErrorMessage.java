...
public enum ServletErrorMessage {
    ...
    // Secrets APIs...
    GAL5090_INVALID_SECRET_NAME_PROVIDED              (5090, "E: Invalid secret name provided. The name of a Galasa secret cannot be empty or contain only spaces or tabs. Check your request query parameters and try again."),
