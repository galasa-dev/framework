...
public class TestAllPropertiesInNamespaceFilteredRoute extends CpsServletTest {
	...
	public void TestGetNamespacesWithFrameworkWithDataNoMatchBadAcceptHeaderReturnsOk() throws Exception{
		...
		checkErrorStructure(outStream.toString(), 5412, "GAL5412",
			"E: Error occured when trying to access the endpoint '/namespace/framework/prefix/prop/suffix/erty'. The request contains the header 'Accept' which does not match the expected value(s): 'application/json , application/* , */*'.");   
	}
