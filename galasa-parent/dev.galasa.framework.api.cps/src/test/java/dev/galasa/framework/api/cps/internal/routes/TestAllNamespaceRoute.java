...
public class TestAllNamespaceRoute extends CpsServletTest {
    ...
    public void TestGetNamespacesNoFrameworkReturnsError () throws Exception{
		// Given...
		setServlet("/namespace",null ,new HashMap<String,String[]>());
	...
	public void TestGetNamespacesWithBadAcceptHeaderWithFrameworkWithDataReturnsOk() throws Exception{
		...
		checkErrorStructure(outStream.toString(), 5412, "GAL5412",
			"E: Error occured when trying to access the endpoint '/namespace'. The request contains the header 'Accept' which does not match the expected value(s): 'application/json , application/* , */*'.");   
	}
    @Test
