package dev.voras.framework.spi.cps;
...
public class CpsProperties {
	 ...
	 * @param defaultValue The default int if property is missing or there is an issue
	 ...
	 * @param cps The Configuration Property Store
	 * @param logger the logger to use if there is a problem
	 * @param defaultValue The default string if property is missing or there is an issue
	 * @param prefix The property prefix
	 * @param suffix The property suffix
	 * @param infixes Options infixes
	 ...
	 * @param cps The Configuration Property Store
	 * @param logger the logger to use if there is a problem
	 * @param defaultValues The default comma separated list if property is missing or there is an issue
	 * @param prefix The property prefix
	 * @param suffix The property suffix
	 * @param infixes Options infixes
	 ...
	 * null or empty strings are removed fromthe list
	 * 
