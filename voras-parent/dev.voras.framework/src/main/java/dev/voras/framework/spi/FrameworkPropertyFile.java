...
/**
 * <p>Used by eJat as an out of the box key value store. It is reccommended to use etcd3 for a performant system.</p>
 * 
 * <p>When provded with a URI to a K-V properties file, the FPF class can provide functionality similar to etcd3, including sets,
 *  gets, deletes, atomic sets and the watchng of values inside the properties.</p>
 *  
 * @author James Davies
 *
 */
...
public class FrameworkPropertyFile implements FileAlterationListener{
	...
	/**
	 *  <p>This constructor loads the properties store in the file into memory. For the watchers to get updates from the file in
	 *  question and not other files in the directory, the observer is intialised with a file filter.</p>
	 * 
	...
	/**
	 * <p> This method retrieves the most up to date value from a specified key. </p>
	 * 
	 * @param key
	...
	/**
	 * <p>This method retrieves a Map of values from the properties file that have a common prefix to the key.</p>
	 * 
	...
	/**
	 * <p> This method deletes a k-v pair from the property store. As the properties file is changed, the fileModified method is invoked
	 *  to update any watchers.</p>
	 * 
	 * @param key - the string key to be removoed from the loaded and file properties.
	 * @throws FrameworkPropertyFileException
	 */
	...
	/**
	 * <p> This method does the same as the regular delete for a single k-v pair, but for a set of key values. Again the fileModified
	 *  is invoked.</>p
	 * 
	...
	/**
	 * <p> This method is used to set a single k-v pair into the properties file. fileModified is invoked as to update watchers to 
	 * any changed values that are being watched.</p>
	 * 
	...
	/**
	 * <p> This method is used for setting multiple k-v pairs into the file. This method is sycnronized on the class to ensure all
	 *  values are set before any other work is completed </p>
	 * 
	...
	/**
	 * <p> This memthod can perform a atomic set. This provides a set functionality in the case where a key is currrenly set to a 
	 *  specific value. If the value is not as expected, then no set is performed. fileModified is invoked to update any possible 
	 *  watches.</p>
	 * 
	...
	/**
	 * <p>This methods also performs and atomic set, but with the additional feature of setting a map of other k-v pairs
	 *  if the old value is found to be the current value</p>
	 * 
	 * <p> This method is sycnronized on the class to ensure all values are set before any other work is completed </p>
	 * 
	 * <p>The method will also fail if the oldvalue is null, which indicates that there is no key of that string.</p>
	...
	/**
	 * <p>This method cleans up the properties in memory, the observers and monitors.</p>
	 * 
	 * @throws FrameworkPropertyFileException
	 */
	...
	/**
	 * <p>This method is for updating any watchers. All running watches are stored in a watches Map. Comparing what is
	 *  loaded in memory to the file version alerts any watches that a value has changed. This alert is interfaced through
	 *  the property modified method</p>
	 * 
	...
	/**
	 *  <p>This method is used for returning a file channel that can be used for reading the property file with a shared 
	 *  lock </p>
	 * 
	...
	/**
	 * <p>This method is used to return a file channel that can be used for writing to the properties file. It is expected
	 *  to be an exlusive lock</p>
	 * 
	...
	/**
	 * <p> This method is used for loading the properties from the java properties file in a memory loaded properties</p>
	 * 
	 * * <p> This method is sycnronized on the class to ensure all values are set before any other work is completed </p>
	 * @throws FrameworkPropertyFileException
	 */
	public synchronized void load() throws FrameworkPropertyFileException {
		...
		synchronized (FrameworkPropertyFile.class) {
			try (FileChannel fileChannel = getReadChannel(true)){
				...
				throw new FrameworkPropertyFileException("Unable to Load Property from file: " + propertyFile.toString(), e );
			}
		}
	...
	/**
	 * <p>This method invoked when the montior thread detects a change to the file being observed</p>
	 * 
	 * <p>As this is an implemented method, it cannot throw a exception so the exception is logged</p>
	 */
	...
	private class Watch {
		...
		/**
		 *  This constructor sets te key for the watcher and a boolean to define whether the key string is a prefix or the full key.
		 *  It also holds the implemented watcher class</p>
		 * 
		...
		/**
		 * <p>This method return a boolean whether a passed string matches the key for this watch.</p>
		 * 
		 * <p> If the watch is a prefix watch it checks to see if the passed string is the start of the key.
