package dev.voras.framework.internal.rps;

import java.io.ByteArrayInputStream;
import java.util.ArrayList;
import java.util.List;

import dev.voras.framework.internal.rps.tree.ASTConstant;
import dev.voras.framework.internal.rps.tree.ASTStart;
import dev.voras.framework.internal.rps.tree.ASTVariable;
import dev.voras.framework.internal.rps.tree.ParseException;
import dev.voras.framework.internal.rps.tree.RpsResolver;
import dev.voras.framework.internal.rps.tree.SimpleNode;
import dev.voras.framework.spi.InsufficientResourcesAvailableException;
import dev.voras.framework.spi.ResourcePoolingServiceException;
...
public class ResourceString {
    ...
    /**
     * This method takes the input string which defines a range of strings and passes it though the JJTree parser we've created
     * which determines if a character is variable or constant.
     * 
...
//        node.dump("   ");
    ...
    /**
     * This method returns the first possible resource name defined in the resource string defintion.
     * 
     * @return - string, for the definition: APPLID{9}{9}{9} the fist would be APPLID000
     */
     ...
     * 
     * @return  string, for the definition: APPLID{9}{9}{9} a random resource could be APPLID359.
     */
    ...
    /**
     * This method returns the next logical string from a defintion. It will increment both numbers and strings based on the 
     * defintion of the chracters in the resource definition string.
     * 
     * @return string, for the previous: APPLID15z, the next resource would be APPLID16a.
     */
    ...
    /**
     * This method calculates and returns the number of combinations that a resource string definition could provide.
     * 
