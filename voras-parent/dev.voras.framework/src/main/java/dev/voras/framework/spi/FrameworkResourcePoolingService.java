...
import dev.voras.framework.internal.rps.ResourceString;

/**
 * This class provides the Resource pooling service to the framework. It can generate resources to a number of specifications. When params are not given, 
 * defaults are used.
 * 
 * @author James Davies
 */
public class FrameworkResourcePoolingService implements IResourcePoolingService{
     ...
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources) throws InsufficientResourcesAvailableException{
        ...
        try {
            ...
            return generateResources(resourceDefinitions, rejectedResources, DEFAULTNUMBEROFRESOURCES, defaultDss, defaultKeyPrefix, DEFAULTCONSECUTIVERESOURCES);
    ...
    /**
     * This method obtaines resources from given definitions, but allowing rejected resources to be disgarded from any returned list. Additionally this method checks against a Dynamic 
     * status store for the resources to ensure they are not in use.
     * 
     * The default return list length is 10.
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
     * @param dss - the dynamic status store to check for the resources.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources, IDynamicStatusStoreService dss, String keyPrefix) throws InsufficientResourcesAvailableException{
        ...
        try {
            resourceDefinitions = createResourceDefintions(resourceStrings);
            return generateResources(resourceDefinitions, rejectedResources, DEFAULTNUMBEROFRESOURCES, dss, keyPrefix, DEFAULTCONSECUTIVERESOURCES);
        } catch (ResourcePoolingServiceException | DynamicStatusStoreException e) {
            throw new InsufficientResourcesAvailableException("Could not generate resource Strings from the definitions provided. ", e);
        }
    }
    ...
    /**
     * This method obtaines resources from given definitions, but allowing rejected resources to be disgarded from any returned list. Additonally this method allows for the number of resources returned in the list 
     * to be defined.
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources, int returnMinimum) throws InsufficientResourcesAvailableException{
        ...
        try {
            resourceDefinitions = createResourceDefintions(resourceStrings);
            return generateResources(resourceDefinitions, rejectedResources, returnMinimum, defaultDss, defaultKeyPrefix, DEFAULTCONSECUTIVERESOURCES);
        } catch (ResourcePoolingServiceException | DynamicStatusStoreException e) {
            throw new InsufficientResourcesAvailableException("Could not generate resource Strings from the definitions provided. ", e);
        }
    }
    ...
    /**
     * This method obtaines resources from given definitions, but allowing rejected resources to be disgarded from any returned list. Additionally this method checks against a Dynamic 
     * status store for the resources to ensure they are not in use. As well, this method allows the number of resources returned to be defined.
     * 
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources, int returnMinimum, IDynamicStatusStoreService dss, String keyPrefix) throws InsufficientResourcesAvailableException{
        ...
        try {
            resourceDefinitions = createResourceDefintions(resourceStrings);
            return generateResources(resourceDefinitions, rejectedResources, returnMinimum, dss, keyPrefix, DEFAULTCONSECUTIVERESOURCES);
        } catch (ResourcePoolingServiceException | DynamicStatusStoreException e) {
            throw new InsufficientResourcesAvailableException("Could not generate resource Strings from the definitions provided. ", e);
        }
    }
     ...
     /**
     * This method obtaines resources from given definitions, but allowing rejected resources to be disgarded from any returned list. Additonally this method allows for the number of resources returned in the list 
     * to be defined, in sections of consecutive resources. For example if i asked for 30 resources with a returnConsecutive of 10, then 3 lots of 10 resources would be in the list. Each 10 would be in a continuous chain.
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
     * @param returnMinimum - the number of resources to return.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources, int returnMinimum, int returnConsecutive) throws InsufficientResourcesAvailableException{
        ...
        try {
            resourceDefinitions = createResourceDefintions(resourceStrings);
            return generateResources(resourceDefinitions, rejectedResources, returnMinimum, defaultDss, defaultKeyPrefix, returnConsecutive);
        } catch (ResourcePoolingServiceException | DynamicStatusStoreException e) {
            throw new InsufficientResourcesAvailableException("Could not generate resource Strings from the definitions provided. ", e);
        }
    }
     ...
     * to be defined, in sections of consecutive resources. For example if i asked for 30 resources with a returnConsecutive of 10, then 3 lots of 10 resources would be in the list. Each 10 would be in a continuous chain.
     * 
     * This method also checks the DSS for the resources to ensure they are not in use.
     * 
     * @param resourceStrings - this is a string list of all the definitions for resources to select from.
     * @param rejectedResources - this is a list of resource names NOT to be included in the returned list.
     * @param returnMinimum - the number of resources to return.
    ...
    public List<String> obtainResources(@NotNull List<String> resourceStrings, List<String> rejectedResources, int returnMinimum, int returnConsecutive, IDynamicStatusStoreService dss, String keyPrefix) throws InsufficientResourcesAvailableException{
        ...
        try {
            resourceDefinitions = createResourceDefintions(resourceStrings);
            return generateResources(resourceDefinitions, rejectedResources, returnMinimum, dss, keyPrefix, returnConsecutive);
        } catch (ResourcePoolingServiceException | DynamicStatusStoreException e) {
            throw new InsufficientResourcesAvailableException("Could not generate resource Strings from the definitions provided. ", e);
        }
    }
    ...
    /**
     * This method creates all the resource string defintions from the basic strings passed which explain them.
     * 
     * @param resourceStrings - list of string like: APPLID{9}{4-7}{F}{z}, etc
     * @return - returns a list of the resource strings which can be used to gather reosources.
     *
    ...
    /**
     * This method generates the resources from the given restrictions. On the first pass random generation is attempted to make sure load is equally spread across resources. If
     * random generation fails, sequential generation of resources is then attempted. The InsufficentResourceException is thrown if this too cannot generate the defined resources.
     * 
     * @param resourceDefinitions - the resource strings passed that define the availabble resources to generate.
     * @param rejectedResources - the resource strings which are to be rejected if generated.
     * @param numberOfResources - the number of resources required to be generated.
     * @param dss - the dynamic status store to check against.
     * @param keyPrefix - the prefix for the resource if it was to be found in the DSS.
     * @param returnConsecutive - the "chunk" size to generate consecutive resources too.
     * @return - a list of generated resource within the constraits passed on this method.
     ...
     int numberOfResources, IDynamicStatusStoreService dss, String keyPrefix, int returnConsecutive) throws DynamicStatusStoreException, InsufficientResourcesAvailableException {
        ...
        try {
            for(int i=0;i<numberOfResources;i+=returnConsecutive) {
                ...
                List<String> newResources = generateRandomResources(randomDefinition, bannedResources, dss, keyPrefix, returnConsecutive);
            ...
            for (ResourceString definition: resourceDefinitions) {
                for (int i=0;i<numberOfResources;i+=returnConsecutive){
                    if (generatedResources.size() == numberOfResources){
                        ...
                        List<String> newResources = generateSequentialResources(definition, bannedResources, dss, keyPrefix, returnConsecutive);
                        generatedResources.addAll(newResources);
                        bannedResources.addAll(newResources);
                    }
                }
     ...
     * 
     * @param definition -the resource string passed that define the available resources to generate.
     * @param bannedReosurceStrings - the resources that are not allowed to be added to the return list
     * @param dss - the dynamic status store to check against.
     * @param keyPrefix  - the prefix for the resource if it was to be found in the DSS.
     * @param returnConsecutive - the "chunk" size to generate consecutive resources too.
    ...
    /**
     * This method is used for sequential generation of resources if the random generation fails. This should only trigger is the attempted number of random generation number is 40% 
     * of the available reosurces.
     * 
     * @param definition -the resource string passed that define the available resources to generate.
     * @param bannedReosurceStrings - the resources that are not allowed to be added to the return list
     * @param dss - the dynamic status store to check against.
    ...
    private class StubbedDss implements IDynamicStatusStoreService{
         ...
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
        public IDynamicRun getDynamicRun() throws DynamicStatusStoreException {return null;}
        /**
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
         ...
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
        public @NotNull Map<String, String> getPrefix(@NotNull String keyPrefix) throws DynamicStatusStoreException{return new HashMap<>();} 
        /**
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
        public String get(@NotNull String key) throws DynamicStatusStoreException{return null;}
        /**
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
        public boolean putSwap(@NotNull String key, String oldValue, @NotNull String newValue, @NotNull Map<String, String> others) throws DynamicStatusStoreException{return true;}
        /**
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
        public boolean putSwap(@NotNull String key, String oldValue, @NotNull String newValue) throws DynamicStatusStoreException{return true;}
        /**
         * Commenting as unused, but required from IDynamicStatusStore implementation.
         */
