...
public interface IConfigurationPropertyStoreRegistration {
	 ...
	 * it should register the CPS with @{link {@link dev.voras.framework.spi.IFrameworkInitialisation#registerConfigurationPropertyStore(IConfigurationPropertyStore)}</p> 
	 * 
