...
import dev.voras.framework.internal.rps.CharacterConstant;
import dev.voras.framework.internal.rps.CharacterVariable;
...
/**
 * This test class ensures the correct behaviour is shown from a variable character for the given methods in ICharacter.
 * 
 * @author James Davies
 */
public class CharacterVariableTest {
    ...
    /**
     * This test method does a simple letter check, a-d. It generates a sample resources and checks its the correct length.
     * @throws ParseException
     */
    @Test
    ...
    /**
     * This test method checks the getNextChar method works with a simple number ranges.
     * @throws ParseException
     */
    @Test
    public void testGetNextChar() throws ParseException{
        ...
        for(int i = 0; i < node.jjtGetNumChildren(); i++) {
            ...
            if (child instanceof ASTVariable) {
                ...
                //assertEquals(Integer.parseUnsignedInt(Character.toString(value))+1, Integer.parseUnsignedInt(Character.toString(vari.getNextChar())));
            } else {
                throw new UnsupportedOperationException("Unrecognised node " + child.getClass().getName());
            }
        }
    ...
    /**
     * This test method makes sure the getNextChar method works across a more complex range.
     * @throws ParseException
     */
    @Test
