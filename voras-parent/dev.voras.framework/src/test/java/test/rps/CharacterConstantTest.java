...
/**
 * This test class ensures that a constant character has constant behaviour, always returning the same chracter.
 * 
 * @author James Davies
 */
public class CharacterConstantTest {
    ...
    /**
     * This test class ensures the same character is always returned from all methods.
